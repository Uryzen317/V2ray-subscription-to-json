...
def convert_uri_reality_json(host, port, socksport, uri, name):
    ...
    return json_file_maker(data, name)


def convert_uri_vless_ws_json(host, port, socksport, uri, name):
...
def convert_uri_vless_tcp_json(host, port, socksport, uri, name):
...
def convert_uri_vmess_ws_json(host, port, socksport, uri, name):
...
def convert_uri_vmess_tcp_json(host, port, socksport, uri, name):
...
def convert_uri_trojan_reality_json(host, port, socksport, uri, name):
...
def convert_uri_trojan_ws_json(host, port, socksport, uri, name):
...
def convert_uri_trojan_tcp_json(host, port, socksport, uri, name):
...
def convert_uri_json(host="127.0.0.1", port=10809, socksport=10808, uri=None, name="unknown"):
    file = "configs.json"
    if uri is None:
        return False
    uri = uri.replace("%2F", "/")
    ...
    if Vless_Reality_checker(uri) is True:
        file = convert_uri_reality_json(host, port, socksport, uri, name)
    elif vless_ws_checker(uri) is True:
        file = convert_uri_vless_ws_json(host, port, socksport, uri, name)
    elif vless_tcp_checker(uri) is True:
        file = convert_uri_vless_tcp_json(host, port, socksport, uri, name)
    elif vmess_ws_checker(uri) is True:
        file = convert_uri_vmess_ws_json(host, port, socksport, uri, name)
    elif vmess_tcp_checker(uri) is True:
        file = convert_uri_vmess_tcp_json(host, port, socksport, uri, name)
    elif trojan_Reality_checker(uri) is True:
        file = convert_uri_trojan_reality_json(host, port, socksport, uri, name)
    elif trojan_ws_checker(uri) is True:
        file = convert_uri_trojan_ws_json(host, port, socksport, uri, name)
    elif trojan_tcp_checker(uri) is True:
        file = convert_uri_trojan_tcp_json(host, port, socksport, uri, name)
    return file

file = convert_uri_json(uri=sys.argv[1], name=sys.argv[2])
